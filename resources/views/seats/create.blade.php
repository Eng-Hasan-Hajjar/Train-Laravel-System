<!-- The Modal -->
<div class="modal fade" id="createSeatModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="create_seat_form" action="{{URL::to('create_seat_url')}}" method="post" >
                <!-- Modal body -->
                <div class="modal-body" style="direction: rtl;text-align: right">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                           <label>العربة</label>
                           <input name="vehicle_num" class="form-control">
                       </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="empty_seat" class="form-control">
                    </div>
                    <div class="form-group">
